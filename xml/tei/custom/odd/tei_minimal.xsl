...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.global.source-source-only_1_ODD_source-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-in-ab-or-p-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-in-l-or-lg-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-title-calendar-calendar-check-title-8-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title" priority="1000" mode="M15">
