...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.global.source-source-only_1_ODD_source-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.spanning-spanTo-spanTo-points-to-following-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.calendarSystem-calendar-calendar-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-p-in-ab-or-p-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-p-in-l-or-lg-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-desc-deprecationInfo-only-in-deprecated-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-target-rt-target-not-span-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-from-rt-from-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-to-rt-to-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-name-calendar-calendar-check-name-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ptr-ptrAtts-18-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-author-calendar-calendar-check-author-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-editor-calendar-calendar-check-editor-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-resp-calendar-calendar-check-resp-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-title-calendar-calendar-check-title-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-meeting-calendar-calendar-check-meeting-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relatedItem-targetorcontent1-26-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-l-abstractModel-structure-l-in-l-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-atleast1oflggapl-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-abstractModel-structure-lg-in-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-sponsor-calendar-calendar-check-sponsor-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-funder-calendar-calendar-check-funder-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-principal-calendar-calendar-check-principal-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-idno-calendar-calendar-check-idno-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-licence-calendar-calendar-check-licence-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-quotation-quotationContents-35-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-citeStructure-match-citestructure-outer-match-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-citeStructure-match-citestructure-inner-match-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-unitDecl-calendar-calendar-check-unitDecl-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-unitDef-calendar-calendar-check-unitDef-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-conversion-calendar-calendar-check-conversion-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-application-calendar-calendar-check-application-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-creation-calendar-calendar-check-creation-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-change-calendar-calendar-check-change-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-div-in-l-or-lg-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-div-in-ab-or-p-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-orgName-calendar-calendar-check-orgName-49-->
   <!--RULE -->
   <xsl:template match="tei:*[@calendar]" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-persName-calendar-calendar-check-persName-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-placeName-calendar-calendar-check-placeName-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-bloc-calendar-calendar-check-bloc-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-country-calendar-calendar-check-country-53-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-region-calendar-calendar-check-region-54-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-settlement-calendar-calendar-check-settlement-55-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-district-calendar-calendar-check-district-56-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-offset-calendar-calendar-check-offset-57-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-geogName-calendar-calendar-check-geogName-58-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-geogFeat-calendar-calendar-check-geogFeat-59-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-affiliation-calendar-calendar-check-affiliation-60-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-age-calendar-calendar-check-age-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-birth-calendar-calendar-check-birth-62-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-climate-calendar-calendar-check-climate-63-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-death-calendar-calendar-check-death-64-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-education-calendar-calendar-check-education-65-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-event-calendar-calendar-check-event-66-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-faith-calendar-calendar-check-faith-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-floruit-calendar-calendar-check-floruit-68-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-gender-calendar-calendar-check-gender-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-langKnowledge-calendar-calendar-check-langKnowledge-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-langKnown-calendar-calendar-check-langKnown-71-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-location-calendar-calendar-check-location-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-nationality-calendar-calendar-check-nationality-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-occupation-calendar-calendar-check-occupation-74-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-persPronouns-calendar-calendar-check-persPronouns-75-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-population-calendar-calendar-check-population-76-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-reforkeyorname-77-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M80">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activemutual-78-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activepassive-79-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-calendar-calendar-check-relation-80-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-residence-calendar-calendar-check-residence-81-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-sex-calendar-calendar-check-sex-82-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-socecStatus-calendar-calendar-check-socecStatus-83-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-state-calendar-calendar-check-state-84-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-terrain-calendar-calendar-check-terrain-85-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-trait-calendar-calendar-check-trait-86-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-objectName-calendar-calendar-check-objectName-87-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-link-linkTargets3-88-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-ab-in-l-or-lg-89-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M92">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-join-joinTargets3-90-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M93">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-standOff-nested_standOff_should_be_typed-91-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M94">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M95">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:author" priority="1000" mode="M96">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:editor" priority="1000" mode="M97">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:resp" priority="1000" mode="M98">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:meeting" priority="1000" mode="M100">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sponsor" priority="1000" mode="M101">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:funder" priority="1000" mode="M102">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:principal" priority="1000" mode="M103">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:idno" priority="1000" mode="M104">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:licence" priority="1000" mode="M105">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDecl" priority="1000" mode="M106">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDef" priority="1000" mode="M107">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:conversion" priority="1000" mode="M108">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:application" priority="1000" mode="M109">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:creation" priority="1000" mode="M110">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change" priority="1000" mode="M111">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:orgName" priority="1000" mode="M112">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:persName" priority="1000" mode="M113">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:placeName" priority="1000" mode="M114">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:bloc" priority="1000" mode="M115">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:country" priority="1000" mode="M116">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:region" priority="1000" mode="M117">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:settlement" priority="1000" mode="M118">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:district" priority="1000" mode="M119">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:offset" priority="1000" mode="M120">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:geogName" priority="1000" mode="M121">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:geogFeat" priority="1000" mode="M122">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:affiliation" priority="1000" mode="M123">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:age" priority="1000" mode="M124">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:birth" priority="1000" mode="M125">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:climate" priority="1000" mode="M126">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:death" priority="1000" mode="M127">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:education" priority="1000" mode="M128">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:event" priority="1000" mode="M129">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:faith" priority="1000" mode="M130">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:floruit" priority="1000" mode="M131">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:gender" priority="1000" mode="M132">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:langKnowledge" priority="1000" mode="M133">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:langKnown" priority="1000" mode="M134">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:location" priority="1000" mode="M135">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:nationality" priority="1000" mode="M136">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:occupation" priority="1000" mode="M137">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:persPronouns" priority="1000" mode="M138">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:population" priority="1000" mode="M139">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M140">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:residence" priority="1000" mode="M141">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sex" priority="1000" mode="M142">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:socecStatus" priority="1000" mode="M143">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:state" priority="1000" mode="M144">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:terrain" priority="1000" mode="M145">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:trait" priority="1000" mode="M146">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:objectName" priority="1000" mode="M147">
