...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.global.source-source-only_1_ODD_source-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.spanning-spanTo-spanTo-points-to-following-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.calendarSystem-calendar-calendar-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-p-in-ab-or-p-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-p-in-l-or-lg-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-desc-deprecationInfo-only-in-deprecated-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-target-rt-target-not-span-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-from-rt-from-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-to-rt-to-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-name-calendar-calendar-check-name-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-18-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-author-calendar-calendar-check-author-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-editor-calendar-calendar-check-editor-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-resp-calendar-calendar-check-resp-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-title-calendar-calendar-check-title-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-meeting-calendar-calendar-check-meeting-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-26-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-in-l-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-lg-in-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-sponsor-calendar-calendar-check-sponsor-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-funder-calendar-calendar-check-funder-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-principal-calendar-calendar-check-principal-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-idno-calendar-calendar-check-idno-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-licence-calendar-calendar-check-licence-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-35-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-outer-match-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-inner-match-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-unitDecl-calendar-calendar-check-unitDecl-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-unitDef-calendar-calendar-check-unitDef-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-conversion-calendar-calendar-check-conversion-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-application-calendar-calendar-check-application-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-creation-calendar-calendar-check-creation-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-change-calendar-calendar-check-change-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-div-in-l-or-lg-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-div-in-ab-or-p-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-49-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-in-l-or-lg-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-51-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-standOff-nested_standOff_should_be_typed-52-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:author" priority="1000" mode="M57">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:editor" priority="1000" mode="M58">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:resp" priority="1000" mode="M59">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title" priority="1000" mode="M60">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:meeting" priority="1000" mode="M61">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sponsor" priority="1000" mode="M62">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:funder" priority="1000" mode="M63">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:principal" priority="1000" mode="M64">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:idno" priority="1000" mode="M65">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:licence" priority="1000" mode="M66">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDecl" priority="1000" mode="M67">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDef" priority="1000" mode="M68">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:conversion" priority="1000" mode="M69">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:application" priority="1000" mode="M70">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:creation" priority="1000" mode="M71">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change" priority="1000" mode="M72">
