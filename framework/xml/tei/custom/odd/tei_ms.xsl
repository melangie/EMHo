...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.global.source-source-only_1_ODD_source-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.spanning-spanTo-spanTo-points-to-following-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.calendarSystem-calendar-calendar-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-structure-p-in-ab-or-p-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-structure-p-in-l-or-lg-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-desc-deprecationInfo-only-in-deprecated-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-target-rt-target-not-span-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-from-rt-from-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-to-rt-to-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-name-calendar-calendar-check-name-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ptr-ptrAtts-18-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-author-calendar-calendar-check-author-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-editor-calendar-calendar-check-editor-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-resp-calendar-calendar-check-resp-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-title-calendar-calendar-check-title-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-meeting-calendar-calendar-check-meeting-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relatedItem-targetorcontent1-26-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-l-abstractModel-structure-l-in-l-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-atleast1oflggapl-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-abstractModel-structure-lg-in-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-sponsor-calendar-calendar-check-sponsor-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-funder-calendar-calendar-check-funder-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-principal-calendar-calendar-check-principal-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-idno-calendar-calendar-check-idno-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-licence-calendar-calendar-check-licence-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-quotation-quotationContents-35-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-outer-match-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-inner-match-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-unitDecl-calendar-calendar-check-unitDecl-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-unitDef-calendar-calendar-check-unitDef-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-conversion-calendar-calendar-check-conversion-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-application-calendar-calendar-check-application-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-creation-calendar-calendar-check-creation-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-change-calendar-calendar-check-change-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-link-linkTargets3-44-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-ab-in-l-or-lg-45-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_ms-join-joinTargets3-46-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-standOff-nested_standOff_should_be_typed-47-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-div-in-l-or-lg-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-div-in-ab-or-p-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-orgName-calendar-calendar-check-orgName-53-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-persName-calendar-calendar-check-persName-54-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-placeName-calendar-calendar-check-placeName-55-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-bloc-calendar-calendar-check-bloc-56-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-country-calendar-calendar-check-country-57-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-region-calendar-calendar-check-region-58-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-settlement-calendar-calendar-check-settlement-59-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-district-calendar-calendar-check-district-60-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-offset-calendar-calendar-check-offset-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-geogName-calendar-calendar-check-geogName-62-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-geogFeat-calendar-calendar-check-geogFeat-63-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-affiliation-calendar-calendar-check-affiliation-64-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-age-calendar-calendar-check-age-65-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-birth-calendar-calendar-check-birth-66-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-climate-calendar-calendar-check-climate-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-death-calendar-calendar-check-death-68-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-education-calendar-calendar-check-education-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-event-calendar-calendar-check-event-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-faith-calendar-calendar-check-faith-71-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-floruit-calendar-calendar-check-floruit-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-gender-calendar-calendar-check-gender-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-langKnowledge-calendar-calendar-check-langKnowledge-74-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-langKnown-calendar-calendar-check-langKnown-75-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-location-calendar-calendar-check-location-76-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-nationality-calendar-calendar-check-nationality-77-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-occupation-calendar-calendar-check-occupation-78-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-persPronouns-calendar-calendar-check-persPronouns-79-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-population-calendar-calendar-check-population-80-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-81-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M84">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-82-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M85">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-83-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M86">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-calendar-calendar-check-relation-84-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-residence-calendar-calendar-check-residence-85-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-sex-calendar-calendar-check-sex-86-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-socecStatus-calendar-calendar-check-socecStatus-87-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-state-calendar-calendar-check-state-88-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-terrain-calendar-calendar-check-terrain-89-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-trait-calendar-calendar-check-trait-90-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-objectName-calendar-calendar-check-objectName-91-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-facsimile-no_facsimile_text_nodes-92-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-path-pathmustnotbeclosed-93-->
   <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M96">
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-addSpan-requires-spanTo-94-->
   <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M97">
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-damageSpan-requires-spanTo-96-->
   <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M98">
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-delSpan-requires-spanTo-98-->
   <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M99">
   ...
   <!--PATTERN schematron-constraint-tei_ms-subst-substContents1-100-->
   <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M100">
   ...
   <!--PATTERN schematron-constraint-tei_ms-msDesc-one_ms_singleton_max-101-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-catchwords-catchword_in_msDesc-102-->
   <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M102">
   ...
   <!--PATTERN schematron-constraint-tei_ms-dimensions-duplicateDim-103-->
   <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M103">
   ...
   <!--PATTERN schematron-constraint-tei_ms-origPlace-calendar-calendar-check-origPlace-104-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-secFol-secFol_in_msDesc-105-->
   <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M105">
   ...
   <!--PATTERN schematron-constraint-tei_ms-signatures-signatures_in_msDesc-106-->
   <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M106">
   ...
   <!--PATTERN schematron-constraint-tei_ms-stamp-calendar-calendar-check-stamp-107-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-msIdentifier-msId_minimal-108-->
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M108">
   ...
   <!--PATTERN schematron-constraint-tei_ms-altIdentifier-calendar-calendar-check-altIdentifier-109-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-binding-calendar-calendar-check-binding-110-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-seal-calendar-calendar-check-seal-111-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-origin-calendar-calendar-check-origin-112-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-provenance-calendar-calendar-check-provenance-113-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-acquisition-calendar-calendar-check-acquisition-114-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-custEvent-calendar-calendar-check-custEvent-115-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M116">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:author" priority="1000" mode="M117">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:editor" priority="1000" mode="M118">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:resp" priority="1000" mode="M119">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title" priority="1000" mode="M120">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:meeting" priority="1000" mode="M121">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sponsor" priority="1000" mode="M122">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:funder" priority="1000" mode="M123">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:principal" priority="1000" mode="M124">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:idno" priority="1000" mode="M125">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:licence" priority="1000" mode="M126">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDecl" priority="1000" mode="M127">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDef" priority="1000" mode="M128">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:conversion" priority="1000" mode="M129">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:application" priority="1000" mode="M130">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:creation" priority="1000" mode="M131">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change" priority="1000" mode="M132">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:orgName" priority="1000" mode="M133">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:persName" priority="1000" mode="M134">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:placeName" priority="1000" mode="M135">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:bloc" priority="1000" mode="M136">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:country" priority="1000" mode="M137">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:region" priority="1000" mode="M138">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:settlement" priority="1000" mode="M139">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:district" priority="1000" mode="M140">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:offset" priority="1000" mode="M141">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:geogName" priority="1000" mode="M142">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:geogFeat" priority="1000" mode="M143">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:affiliation" priority="1000" mode="M144">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:age" priority="1000" mode="M145">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:birth" priority="1000" mode="M146">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:climate" priority="1000" mode="M147">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:death" priority="1000" mode="M148">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:education" priority="1000" mode="M149">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:event" priority="1000" mode="M150">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:faith" priority="1000" mode="M151">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:floruit" priority="1000" mode="M152">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:gender" priority="1000" mode="M153">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:langKnowledge" priority="1000" mode="M154">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:langKnown" priority="1000" mode="M155">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:location" priority="1000" mode="M156">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:nationality" priority="1000" mode="M157">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:occupation" priority="1000" mode="M158">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:persPronouns" priority="1000" mode="M159">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:population" priority="1000" mode="M160">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M161">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:residence" priority="1000" mode="M162">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sex" priority="1000" mode="M163">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:socecStatus" priority="1000" mode="M164">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:state" priority="1000" mode="M165">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:terrain" priority="1000" mode="M166">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:trait" priority="1000" mode="M167">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:objectName" priority="1000" mode="M168">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:origPlace" priority="1000" mode="M169">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:stamp" priority="1000" mode="M170">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:altIdentifier" priority="1000" mode="M171">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:binding" priority="1000" mode="M172">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:seal" priority="1000" mode="M173">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:origin" priority="1000" mode="M174">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:provenance" priority="1000" mode="M175">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:acquisition" priority="1000" mode="M176">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:custEvent" priority="1000" mode="M177">
