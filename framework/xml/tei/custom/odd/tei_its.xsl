...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_its-att.global.source-source-only_1_ODD_source-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.spanning-spanTo-spanTo-points-to-following-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-att.calendarSystem-calendar-calendar-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-p-in-ab-or-p-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-p-in-l-or-lg-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-desc-deprecationInfo-only-in-deprecated-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-target-rt-target-not-span-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-from-rt-from-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-to-rt-to-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-name-calendar-calendar-check-name-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-ptr-ptrAtts-18-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-author-calendar-calendar-check-author-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-editor-calendar-calendar-check-editor-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-resp-calendar-calendar-check-resp-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-title-calendar-calendar-check-title-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-meeting-calendar-calendar-check-meeting-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-relatedItem-targetorcontent1-26-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_its-l-abstractModel-structure-l-in-l-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-atleast1oflggapl-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-abstractModel-structure-lg-in-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-sponsor-calendar-calendar-check-sponsor-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-funder-calendar-calendar-check-funder-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-principal-calendar-calendar-check-principal-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-idno-calendar-calendar-check-idno-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-licence-calendar-calendar-check-licence-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-quotation-quotationContents-35-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-citeStructure-match-citestructure-outer-match-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-citeStructure-match-citestructure-inner-match-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-unitDecl-calendar-calendar-check-unitDecl-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-unitDef-calendar-calendar-check-unitDef-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-conversion-calendar-calendar-check-conversion-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-application-calendar-calendar-check-application-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-creation-calendar-calendar-check-creation-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-change-calendar-calendar-check-change-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-div-in-l-or-lg-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-div-in-ab-or-p-48-->
   <!--RULE -->
