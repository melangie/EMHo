...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.measurement-att-measurement-unitRef-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.typed-subtypeTyped-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.pointing-targetLang-targetLang-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.spanning-spanTo-spanTo-points-to-following-7-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.calendarSystem-calendar-calendar-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-p-abstractModel-structure-p-in-ab-or-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-p-abstractModel-structure-p-in-l-or-lg-11-->
   <!--RULE -->
   ...
   <!--RULE -->
   <xsl:template match="tei:rt/@target" priority="1000" mode="M19">
   ...
   <!--RULE -->
   <xsl:template match="tei:rt/@from" priority="1000" mode="M20">
   ...
   <!--RULE -->
   <xsl:template match="tei:rt/@to" priority="1000" mode="M21">
   ...
   <!--PATTERN schematron-constraint-tei_drama-name-calendar-calendar-check-name-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-author-calendar-calendar-check-author-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-editor-calendar-calendar-check-editor-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-resp-calendar-calendar-check-resp-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-title-calendar-calendar-check-title-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-meeting-calendar-calendar-check-meeting-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-relatedItem-targetorcontent1-25-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_drama-l-abstractModel-structure-l-in-l-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-atleast1oflggapl-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-abstractModel-structure-lg-in-l-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-sponsor-calendar-calendar-check-sponsor-29-->
   <!--RULE -->
   <xsl:template match="tei:*[@calendar]" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_drama-funder-calendar-calendar-check-funder-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-principal-calendar-calendar-check-principal-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-idno-calendar-calendar-check-idno-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-licence-calendar-calendar-check-licence-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-quotation-quotationContents-34-->
   <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M40">
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-citeStructure-match-citestructure-outer-match-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-citeStructure-match-citestructure-inner-match-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-unitDecl-calendar-calendar-check-unitDecl-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-unitDef-calendar-calendar-check-unitDef-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-conversion-calendar-calendar-check-conversion-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-application-calendar-calendar-check-application-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-creation-calendar-calendar-check-creation-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-change-calendar-calendar-check-change-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-div-in-l-or-lg-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-div-in-ab-or-p-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-link-linkTargets3-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-ab-in-l-or-lg-49-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-join-joinTargets3-50-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M53">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-standOff-nested_standOff_should_be_typed-51-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M54">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:author" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:editor" priority="1000" mode="M57">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:resp" priority="1000" mode="M58">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title" priority="1000" mode="M59">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:meeting" priority="1000" mode="M60">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sponsor" priority="1000" mode="M61">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:funder" priority="1000" mode="M62">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:principal" priority="1000" mode="M63">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:idno" priority="1000" mode="M64">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:licence" priority="1000" mode="M65">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDecl" priority="1000" mode="M66">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unitDef" priority="1000" mode="M67">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:conversion" priority="1000" mode="M68">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:application" priority="1000" mode="M69">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:creation" priority="1000" mode="M70">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change" priority="1000" mode="M71">
